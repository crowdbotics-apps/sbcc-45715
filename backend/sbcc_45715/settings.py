"""
Django settings for sbcc_45715 project.
...
WSGI_APPLICATION = 'sbcc_45715.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sbcc_45715 API",
    "DESCRIPTION": "API documentation for sbcc_45715 App",
    "VERSION": "v1",
}
